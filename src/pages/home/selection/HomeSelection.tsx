...
export default function HomeSelection(): ReactElement {
    return (
        <section className="home-selection">
            ...
            <div className="selection_grid container">
                <div className="selection_place">
                    <div className="selection_place-header">
                        <span className="selection_place-name">Green Place</span>
                        <span className="selection_place-city">Laval</span>
                    </div>
                    <div className="selection_place-containt">
                        <img src={imgPlace1} alt="Green Place" />
                        <div className="selection_place-note">
                        ...
                        <div className="selection_place-comment">
                            <span>«</span>
                            <span className="selection_place-comment-text">
                                Très joli lieu de coworking : bureaux spacieux, jardin,
                                cuisine équipée avec bureaux nomades, super ambiance de travail !
                            </span>
                            <span>»</span>
                        </div>
                        <div className="selection_place-overlay">
                ...
                <div className="selection_place">
                    <div className="selection_place-header">
                        <span className="selection_place-name">eCafé</span>
                        <span className="selection_place-city">Château-Gontier</span>
                    </div>
                    <div className="selection_place-containt">
                ...
                <div className="selection_place">
                    <div className="selection_place-header">
                        <span className="selection_place-name">La Bulle Verte</span>
                        <span className="selection_place-city">Mayenne</span>
                    </div>
                    <div className="selection_place-containt">
